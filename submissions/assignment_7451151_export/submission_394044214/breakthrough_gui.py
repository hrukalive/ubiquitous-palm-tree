...
if __name__ == "__main__":
    ...
    black_agent = AlphaBetaAgent("AlphaBeta Off1", depth=4, eval_fn=defensive_eval_2)
    # white_agent = MinimaxAgent("AlphaBeta Off1", depth=4, eval_fn=defensive_eval_1)
    # black_agent = None                      # Setting agent to None will let human play.
    # black_agent = AlphaBetaAgent("AlphaBeta Def1", depth=6, eval_fn=defensive_eval_1)
    # white_agent = RandomAgent("radom Def1")
    white_agent = AlphaBetaAgent("AlphaBeta Def1", depth=4, eval_fn=defensive_eval_1)
    # black_agent = MinimaxAgent("AlphaBeta Def1", depth=4, eval_fn=offensive_eval_1)
