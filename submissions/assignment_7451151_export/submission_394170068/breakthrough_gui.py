...
if __name__ == "__main__":
    ...
    # white_agent = MinimaxAgent("Robot")                      # Setting agent to None will let human play.
    # white_agent = None#AlphaBetaAgent("AlphaBeta Off1", depth=4, eval_fn=offensive_eval_1)
    white_agent = None #AlphaBetaAgent("AlphaBeta Off1", depth=4, eval_fn=offensive_eval_2)                      # Setting agent to None will let human play.
    black_agent = AlphaBetaAgent("AlphaBeta Def1", depth=4, eval_fn=offensive_eval_2)
