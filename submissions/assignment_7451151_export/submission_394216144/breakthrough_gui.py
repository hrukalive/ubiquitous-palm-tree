...
if __name__ == "__main__":
    ...
    # Options for agents:
    # None = Human player (click to move)
    # MinimaxAgent = AI using minimax search
    # RandomAgent = AI that picks random moves
    
    white_agent = None                      # Human plays WHITE
    black_agent = MinimaxAgent("Minimax", depth=2, eval_fn=defensive_eval_1)  # AI plays BLACK
