...
if __name__ == "__main__":
    ...
    white_agent = AlphaBetaAgent("AlphaBeta Def1", depth=4, eval_fn=offensive_eval_2)                        # Setting agent to None will let human play.
    # white_agent = AlphaBetaAgent("AlphaBeta Off1", depth=4, eval_fn=offensive_eval_1)
    black_agent = AlphaBetaAgent("AlphaBeta Def1", depth=4, eval_fn=defensive_eval_1)                        # Setting agent to None will let human play.
