...
def main(white_agent, black_agent):
    ...
    #TODO : REMOVE MY ADDITIONS HERE
    # print("initial actions: ", game.actions(state))
    print("\n", game.display(state))
    ########################
...
if __name__ == "__main__":
    ...
    # from breakthrough import net_eval #another test eval
    ...
    # black_agent = MinimaxAgent(name="mini max def1", depth=3, eval_fn=defensive_eval_1)
    black_agent = AlphaBetaAgent(name="alphabeta off2", depth=4, eval_fn=offensive_eval_2)
