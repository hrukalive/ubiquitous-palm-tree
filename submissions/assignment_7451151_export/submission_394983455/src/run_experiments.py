...
#                  | |
#                  |_|
# YOUR NAME: Sweeney Han
# YOUR WPI ID: 901017842
...
def main():
    ...
    whiteagent = MinimaxAgent("MiniMax Off1", depth = 3, eval_fn = offensive_eval_1)
    blackagent = AlphaBetaAgent("AlphaBeta Off1", depth = 4, eval_fn = offensive_eval_1)
    result = play_game(whiteagent, blackagent)
    print(result, "\n")
    ...
    whiteagent = AlphaBetaAgent("AlphaBeta Off2", depth=4, eval_fn=offensive_eval_2)
    blackagent = AlphaBetaAgent("AlphaBeta Def1", depth=4, eval_fn=defensive_eval_1)
    result = play_game(whiteagent, blackagent)
    print(result, "\n")
    ...
    whiteagent = AlphaBetaAgent("AlphaBeta Def2", depth=4, eval_fn=defensive_eval_2)
    blackagent = AlphaBetaAgent("AlphaBeta Off1", depth=4, eval_fn=offensive_eval_1)
    result = play_game(whiteagent, blackagent)
    print(result, "\n")
    ...
    whiteagent = AlphaBetaAgent("AlphaBeta Off2", depth=4, eval_fn=offensive_eval_2)
    blackagent = AlphaBetaAgent("AlphaBeta Def2", depth=4, eval_fn=defensive_eval_2)
    result = play_game(whiteagent, blackagent)
    print(result, "\n")
