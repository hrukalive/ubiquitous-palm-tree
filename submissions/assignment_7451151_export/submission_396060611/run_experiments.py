...
#                  | |
#                  |_|
# YOUR NAME: Yuankai Shen
# YOUR WPI ID: 901013096
...
def main():
    ...
    matchups = [
        ...
        ("M Off1", MinimaxAgent("MinimaxOff1",3,offensive_eval_1),
         "AB Off1", AlphaBetaAgent("ABOff1",4,offensive_eval_1)),

        ("AB Off2", AlphaBetaAgent("ABOff2",4,offensive_eval_2),
         "AB Def1", AlphaBetaAgent("ABDef1",4,defensive_eval_1)),
    ...
    for name1, agent1, name2, agent2 in matchups:
        ...
        res = play_game(agent1, agent2, progress=True)
